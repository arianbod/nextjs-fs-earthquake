				...
				<ul>
					...
					{messages.map(({ role, content }, index) => {
						...
						return (
							<li
								key={id}
								className={`flex items-baseline gap-3 py-6 px-4 text-lg leading-loose border-b border-gray-300 dark:border-gray-700 ${
									role === 'assistant'
										? 'bg-gray-100 dark:bg-gray-800 dark:text-gray-100 px-12'
