...
const EnhancedCertificate = ({ score, userInput }) => {
	...
	return (
		<div className='bg-white border-8 border-double border-gray-300 p-8 max-w-2xl mx-auto my-8 text-center'>
			<h1 className='text-3xl font-bold mb-4'>Deprem Platform</h1>
			...
			<p className='mb-4'>
				...
				, has been thoroughly analyzed by the Deprem Platform.
			</p>
			...
			<p className='mb-6'>
				...
				performed by the Deprem Platform.
			</p>
